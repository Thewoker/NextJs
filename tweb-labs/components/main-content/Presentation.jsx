            ...
            <section className=''>
                <article className='block py-0'>
                    <div className='flex justify-center items-center'>
                        <p className='w-1/2 p-4 text-md px-20'>
                        ...
                        <div className='w-1/2 px-4 py-1'>
                            <img className="" src="/imgs/Description-1.webp" alt="" />
                        </div>
                    </div>
                </article>
                <article className='block py-0'>
                    <div className='flex justify-center items-center'>
                        <div className='w-1/2 px-4 py-1'>
                            <img className="" src="/imgs/Description-2-1.jpg" alt="" />
                        </div>
                        <p className='w-1/2 p-4 text-md px-20'>
                ...
                <article className='block py-0'>
                    <div className='flex justify-center items-center'>
                        ...
                        <div className='w-1/2 px-4 py-1'>
                            <img className="" src="/imgs/Description-2-2.jpg" alt="" />
                        </div>
                    </div>
                </article>
            </section>
