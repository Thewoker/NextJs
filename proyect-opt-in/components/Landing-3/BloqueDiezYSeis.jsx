...
function BloqueDiezYSeis() {
    return (
        <div className='min-h-screen  min-w-screen flex flex-col items-center justify-center md:px-24 max-md:flex-wrap max-md:h-full gap-5'>
            <h2 className='text-6xl text-center'><b>Por que no tenemos competencia?</b></h2>
            <div className='flex w-full'>
                ...
                <div className='w-1/2 flex flex-col justify-center items-center gap-3'>
                    <div className='flex gap-3'>
                        <div className='w-1/2 bg-[#4472c4] p-2 flex justify-center items-center rounded-lg text-white'>
