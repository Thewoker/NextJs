    ...
    return (
        <div className='min-h-screen md:px-24 division-declinada max-md:h-full flex justify-center max-md:flex-wrap items-center gap-5 max-md:p-5 max-md:pb-20'>
            <div className='flex flex-col justify-center items-center gap-1 md:w-1/2 max-md:w-full'>
                ...
                <p className='text-3xl text-center md:w-1/2 md:text-white'>Si tenes dudas respecto de si esta mentoría te servirá o no, agenda una Pre-Revisión de 15 minutos con alguien de nuestro equipo para sacarte todas las dudas y ver si podemos ayudar</p>
            </div>
