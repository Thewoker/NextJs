...
function BloqueDiez() {
    return (
        <div className='min-h-screen md:h-screen min-w-screen flex relative items-center md:px-24 md:pt-24 max-md:flex-wrap max-md:h-full gap-5 division-inclinada'>
            <div className='w-1/2'>
            ...
            <div className='w-1/2'>
                <h2 className='text-center text-4xl md:px-10 text-white'>
                ...
                <p className='text-xs text-white absolute right-5 bottom-0'>(*) El reintegro se efectua a los 30 días  en que la persona firme el contrato de adhesion</p>
            </div>
        </div>
    )
}
