...
function BloqueVientiDos() {
  return (
    <div className='min-h-screen min-w-screen flex flex-col items-center justify-center gap-20'>
        ...
        <h2 className='text-center text-2xl'><b>MIRA ESTE CUADRO QUE TE MUESTRO ACA... <br />CUÁNTO CREES QUE VALE?</b></h2>
        <img src="./imgs/landing-2/cuadro.png" alt="" />
        <p className='text-center text-xl'>TODO BLANCO???? ¡ALGUIEN APURADO PODRÍA DECIR QUE NO VALE NADA!</p>
    </div>
  )
}
