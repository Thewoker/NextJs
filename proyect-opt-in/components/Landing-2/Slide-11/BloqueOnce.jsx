        ...
        <div className='min-h-screen min-w-screen flex flex-col items-center justify-center relative max-md:pt-20'>
            ...
            <div className='flex w-full gap-10 justify-center items-center md:p-24 max-md:flex-wrap max-md:h-full'>
                ...
                <div className='flex flex-col gap-3 w-full max-md:px-10'>
                    ...
                    <div className='flex gap-3 items-center'>
                        <img src="./imgs/landing-2/check.svg" className='w-[20px] h-[20px]' alt="" />
                        <p className='roboto'>Soy Lic en Economía, con postgrados en Negocios, Management, Negociación. </p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <img src="./imgs/landing-2/check.svg" className='w-[20px] h-[20px]' alt="" />
                        <p className='roboto'>Tengo 25 años de experiencia en Comercial, Marketing Publicidad</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <img src="./imgs/landing-2/check.svg" className='w-[20px] h-[20px]' alt="" />
                        <p className='roboto'>Trabaje en Comercio Exterior y recorrí infinidad de países y culturas aprendiendo de la diversidad</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <img src="./imgs/landing-2/check.svg" className='w-[20px] h-[20px]' alt="" />
                        <p className='roboto'>Hago que las cosas sucedan y seo me enorgullece</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <img src="./imgs/landing-2/check.svg" className='w-[20px] h-[20px]' alt="" />
                        <p className='roboto'>Hace 5 años me volqué al mercado inmobiliario</p>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <img src="./imgs/landing-2/check.svg" className='w-[20px] h-[20px]' alt="" />
                        <p className='text-[#ff0000] roboto'>¡RUBRO QUE ME APASIONA POR EL POTENCIAL QUE TIENE Y POR COMO SE PUEDE TRANSFORMAR PARA BIEN LA VIDA DE UNA FAMILIA!</p>
                    </div>
                </div>
            </div>
        </div>
