    ...
    return (
        <div className='min-h-screen min-w-screen flex flex-col items-center justify-center gap-20 md:px-24 max-md:flex-wrap max-md:h-full'>
            ...
            <div className='w-full grid grid-cols-3 gap-3'>
                <div className='flex col-span-3 justify-center items-center h-[150px] bg-[#1a1da0] p-3'><p className='text-center text-white'>Termine ingresando en una inmobiliaria en la cual dure muy pocos meses, no podía creer el destrato hacia los clientes.<br />Me cambie a otra, y a otra</p></div>
                <div className='flex col-span-3 justify-center items-center h-[150px] bg-[#1a1da0] p-3'><p className='text-center text-white'><b>Contraté Coaches, compré Cursos, lei muchísimo.. y empecé a<br />entrevistarme con agentes e inmobiliarias de todo el mundo.</b></p></div>
                <div className='flex col-span-3 justify-center items-center h-[150px] bg-[#1a1da0] p-3'><p className='text-center text-white'>Cada persona que entreviste (sobre todo del exterior) me empezó a dar <br />una pista para armar un sistema de venta de excelencia</p></div>
            </div>
        </div>
    )
}
