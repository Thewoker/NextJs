...
function BloqueDiezYSiete() {
    return (
        <div className='min-h-screen min-w-screen flex items-center justify-center gap-10 division-inclinada max-md:flex-wrap max-md:h-full'>
            <div className='flex flex-col items-center justify-center w-full gap-10'>
                <h2 className=''><b>Y TE VOY A CONTAR ALGO QUE NO MUCHA GENTE TIENE CLARO…</b></h2>
            ...
            <div className='flex flex-col w-full h-full justify-center items-center gap-5'>
                <h3 className='md:text-white text-center'><b>PERO ENTONCES CUANDO LOS PRECIOS ESTAN BAJOS VENDO <br /> BARATO PERO COMPRO BARATO Y LA DIFERENCIA A INVERTIR ES <br />MAS PEUQEÑA?</b></h3>
                <h2 className='md:text-white text-center text-6xl'><b>Si</b></h2>
                <h3 className='md:text-white text-center'><b>PERO ESTA OPORTUNIDAD NO VA A DURAR PARA <br />SIEMPRE</b></h3>
            </div>
        </div>
    )
}
